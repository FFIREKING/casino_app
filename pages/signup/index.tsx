    ...
    <>
      <DefaultForm onSubmit={handleSubmit} title={t('Sign_Up')} submitTitle={t('Sign_Up')}>
        <div className="d-flex flex-column gap-4">
          ...
          <div className="form-group">
            <input id="phone" name="phone" type="text" className="form-control form-control-lg" placeholder={'핸드폰번호 "-"제외 ex)010xxxxxxxx'} minLength={9} maxLength={11} required />
          </div>

          <div className="form-group">
            <input name="bank_name" type="text" className="form-control form-control-lg" placeholder={'은행이름'} minLength={2} maxLength={20} required />
          </div>

          <div className="form-group">
            <input name="acc_num" type="text" className="form-control form-control-lg" placeholder={'계좌번호'} minLength={2}  required />
          </div>
          ...
          <div className="form-group">
            ...
            {check && <input  name="referral_code"  className="form-control form-control-lg" placeholder={"추천인코드"} maxLength={20}
